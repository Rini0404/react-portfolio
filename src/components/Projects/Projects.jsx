      ...
      <div class="flex flex-wrap justify-center gap-12 container mx-auto p-10 ">
        <div class="w-[360px] h-[480px] py-8 px-1">
          <div class="relative flex flex-col justify-center items-center w-[300px] h-[400px] mx-auto p-2 bgCards border-white border-2 rounded-3xl">
            ...
            <button
                type="button"
                className="px-8 py-3 font-semibold rounded-full dark:bg-gray-100 dark:text-gray-800 btnP"
                target = "_blank"
              ...
              <button
                type="button"
                className="btnP px-8 py-3 font-semibold rounded-full dark:bg-gray-100 dark:text-gray-800"
              ><a href ="https://pc-architect.herokuapp.com/" target = "_blank"> Live Link </a>
              </button>
            </div>
            <h3 class="absolute -top-5 -left-5 w-32 p-2 bg-slate-800  rounded-3xl text-2xl font-merriweather text-center  text-white  border-white border-2">
              Pc Architect
            </h3>
            ...
            >
              <img
                ...
                class="object-fill imgBg"
              />
            </div>

            <p class="absolute -bottom-12 left-6 w-[300px] p-4 bg-slate-800 text-slate-50 rounded-3xl hover:text-white  border-white border-2">
        ...
        <div class="w-[360px] h-[480px] py-8 px-1">
          <div class="relative flex flex-col justify-center items-center w-[300px] h-[400px] mx-auto p-2 bgCards border-white border-2 rounded-3xl">
            ...
            <h3 class="absolute -top-5 -left-5 w-32 p-2 bg-slate-800  border-white text-white border-2 rounded-3xl text-2xl font-merriweather text-center">
              That Good Dirt
            </h3>
...
// relative flex flex-col justify-center items-center w-[300px] h-[400px] mx-auto p-2 bgCards border-white text-slate-50 shadow-lg rounded-3xl hover:shadow-xl