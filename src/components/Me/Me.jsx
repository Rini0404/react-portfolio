        ...
        <section className="bgForPjects">
            <div className="container max-w-xl p-6 py-12 mx-auto space-y-24 lg:px-8 lg:max-w-7xl">
                <div className="backdrop-blur rounded-xl">
                    <h2 className="text-3xl font-bold tracking-tight text-center sm:text-5xl dark:text-gray-50">Let me introduce <span className="font-bold text-fuchsia-500">Myself</span></h2>
